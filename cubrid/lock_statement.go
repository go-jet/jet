...
// LockStatement is interface for CUBRID LOCK tables
...
func (l *lockStatementImpl) READ() Statement  { l.Read.Show = true; return l }
func (l *lockStatementImpl) WRITE() Statement { l.Write.Show = true; return l }
