...
For now there is no guarantee that public API will remain backward compatible. Please read the release draft to get acquaint how to fix with possible API build breakable changes.
