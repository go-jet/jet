...
func TestSelectPreparedStatement(t *testing.T) {
	...
	for i := 1; i < 20; i++ {
		...
		// db prepared statement use case
		...
		// tx prepared statement use case
		...
		// conn prepared statement use case
		...
		// database tx prepared statement use case
		...
		// rows prepared statement use case
